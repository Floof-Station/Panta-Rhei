...
public sealed partial class MilkerComponent : Component
{
    ...
    [DataField]
    public FixedPoint2 MilkedAmount = 3; // Amount to be milked
    ...
    [DataField]
    public float TubeLength = 2; // Maximum length of the tube

    [DataField]
    public Vector2 TubeOffsetSource, TubeOffsetTarget = Vector2.Zero;

    /// <summary>
    ///     ID of the rope entity attached to the milked entity, if any.
    /// </summary>
    public EntityUid? RopeEntity;

    /// <summary>
    ///     Rope prototype used to create a rope when attaching.
    /// </summary>
    public ProtoId<RopeConfigurationPrototype> RopePrototype = "MilkingMachine10";
}
