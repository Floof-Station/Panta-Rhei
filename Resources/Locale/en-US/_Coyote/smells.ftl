...
scent-examine-one      = [color=DarkGray]{CAPITALIZE(SUBJECT($scenter))} {CONJUGATE-BASIC($scenter, "smell", "smells")} like {$scent}.[/color]
# She smells like butt and cheese
scent-examine-two      = [color=DarkGray]{CAPITALIZE(SUBJECT($scenter))} {CONJUGATE-BASIC($scenter, "smell", "smells")} like {$scent1} and {$scent2}.[/color]
# She smells like butt, cheese, bingus, coffee, cheetos and chicken
scent-examine-multiple = [color=DarkGray]{CAPITALIZE(SUBJECT($scenter))} {CONJUGATE-BASIC($scenter, "smell", "smells")} like {$scents}, with a hint of {$lastscent}.[/color]
# Euphoria - Less distracting.
