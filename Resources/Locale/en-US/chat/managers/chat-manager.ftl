...
chat-manager-entity-say-wrap-message = [BubbleHeader][bold][Name]{$entityName}[/Name][/bold][/BubbleHeader]{chat-manager-language-hint} {$verb} [font={$fontType} size={$fontSize}]“[BubbleContent][color={$textColor}]{$message}[/color][/BubbleContent]”[/font]
chat-manager-entity-say-bold-wrap-message = [BubbleHeader][bold][Name]{$entityName}[/Name][/bold][/BubbleHeader]{chat-manager-language-hint} {$verb} [font={$fontType} size={$fontSize}]“[BubbleContent][bold][color={$textColor}]{$message}[/color][/bold][/BubbleContent]”[/font]
