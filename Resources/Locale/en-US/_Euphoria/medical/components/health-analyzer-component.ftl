health-analyzer-window-entity-unrevivable-text-short = [color=yellow]Can not be resuscitated by normal means![/color]
health-analyzer-window-entity-bleeding-text-short = [color=red]Has open wounds![/color]
...
rotting-extremely-bloated-short = [color=red]Corpse is extremely bloated![/color]
