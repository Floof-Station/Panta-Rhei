corruptible-component-corruption-start = Your sorrow touches the heart of {THE($target)} and seeps in deep...
corruptible-component-decorruption-start = A purifying light gleams from {THE($used)}!
