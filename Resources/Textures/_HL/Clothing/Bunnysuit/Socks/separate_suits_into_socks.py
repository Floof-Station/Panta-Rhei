#!/usr/bin/env python3
# Disclaimer: this script was generated by an LLM and heavily modified by me for the sole purpose of extracting sock sprites out of suits
# It may be possible to re-use it for other clothing, but you'll need to:
...
# - If there's no icon.png in the same directory, generates it by cropping the masked part and offsetting it.
